...
const HEALTH_CATEGORIES = {
    "start": {
        ...
        "options": [
            ...
            "২. প্রজনন স্বাস্থ্য এবং PCOS (পলিসিস্টিক ওভারি সিনড্রোম)",
            "৩. স্তন ও জরায়ু ক্যান্সার এবং অন্যান্য মহিলা-সম্পর্কিত ক্যান্সার",
            "৪. স্থূলতা, উচ্চ রক্তচাপ, আর্থ্রাইটিস এবং অন্যান্য দীর্ঘস্থায়ী রোগ",
            "৫. মানসিক স্বাস্থ্য"
        ],
        "nextStateMap": {
            "১. মাসিক সংক্রান্ত সমস্যা": "menstrual_health",
            "২. পপ্রজনন স্বাস্থ্য PCOS (পলিসিস্টিক ওভারি সিনড্রোম)": "reproductive_PCOS_hormonal_health",
            "৩. স্তন ও জরায়ু ক্যান্সার এবং অন্যান্য মহিলা-সম্পর্কিত ক্যান্সার": "cancer_health",
            "৪. স্থূলতা, উচ্চ রক্তচাপ, আর্থ্রাইটিস এবং অন্যান্য দীর্ঘস্থায়ী রোগ": "other_health",
    ...
    "reproductive_sexual_health": {
        ...
        "options": ["গর্ভধারণে সমস্যা", "যৌন স্বাস্থ্য", "গর্ভনিরোধ", "প্রসবোত্তর সমস্যা", "অন্যান্য"]
    },
    "PCOS_hormonal_health": {
        "botPrompt": "PCOS সংক্রান্ত কোন সমস্যা নিয়ে জানতে চান?",
        "options": ["PCOS এর লক্ষণ", "চিকিৎসা পদ্ধতি", "খাদ্যাভ্যাস ও জীবনযাত্রা", "গর্ভধারণে সমস্যা", "অন্যান্য"]
    },
    "cancer_health": {
...
"reproductive_PCOS_hormonal_health": {
  "botPrompt": "আপনি কি প্রজনন স্বাস্থ্য সংক্রান্ত সমস্যা নিয়ে কথা বলতে চান নাকি PCOS সংক্রান্ত সমস্যা নিয়ে?",
  "options": [
    "আমি প্রজনন স্বাস্থ্য নিয়ে কথা বলতে চাই",
    "আমি শুধুমাত্র PCOS নিয়ে কথা বলতে চাই"
  ],
  "nextStateMap": {
    "আমি প্রজনন স্বাস্থ্য নিয়ে কথা বলতে চাই": "reproductive_sexual_health",
    "আমি শুধুমাত্র PCOS নিয়ে কথা বলতে চাই": "PCOS_hormonal_health"
  }
}
...
const healthMainMenu = [
    "১. মাসিক সংক্রান্ত সমস্যা",
    "২. প্রজনন স্বাস্থ্য",
    "৩. PCOS (পলিসিস্টিক ওভারি সিনড্রোম)",
    "৪. স্তন বা জরায়ু ক্যান্সার",
    "৫. স্থূলতা, উচ্চ রক্তচাপ বা আর্থ্রাইটিস"
];
...
};  // ← Close the object AFTER all properties are added



// Map Bengali to English keys
const nextStateMap = {
    "১. মাসিক সংক্রান্ত সমস্যা" : "menstrual_heath",
    "২. প্রজনন স্বাস্থ্য এবং PCOS (পলিসিস্টিক ওভারি সিনড্রোম)" : "reproductive_PCOS_hormonal_health"
    "৩. স্তন ও জরায়ু ক্যান্সার এবং অন্যান্য মহিলা-সম্পর্কিত ক্যান্সার" : "cancer_health",
    "৪. স্থূলতা, উচ্চ রক্তচাপ, আর্থ্রাইটিস এবং অন্যান্য দীর্ঘস্থায়ী রোগ" : "other health"
    "৫. মানসিক স্বাস্থ্য" : "mental_health"
};
...
function handleMainMenuSelection(userInput) {
  ...
  const stateKey = nextStateMap[userInput];
