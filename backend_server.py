...
async def startup_event():
    ...
    global rag_chain
    print("\n" + "=" * 60)
    print("🚀 Starting Health Chatbot Backend Server...")
    print("=" * 60)
...
@app.get("/neurohealth")
async def serve_frontend_wh():
    """Serve HTML frontend"""
    html_path = "index_neurohealth.html"
    if os.path.exists(html_path):
        ...
        return {
            "status": "running",
            "message": "NeuroHealth Health Chatbot API",
...
async def serve_frontend_wh():
    """Serve HTML frontend"""
    html_path = "index_pethealth.html"
    if os.path.exists(html_path):
        return FileResponse(
            html_path,
            headers={
...
@app.get("/childhealth")
async def serve_frontend_ch():
    """Serve HTML frontend"""
    html_path = "index_childhealth.html"
    if os.path.exists(html_path):
        return FileResponse(
            html_path,
            headers={
...
@app.get("/cancerhealth")
async def serve_frontend_ch():
    """Serve HTML frontend"""
    html_path = "index_cancerhealth.html"
    if os.path.exists(html_path):
        return FileResponse(
            html_path,
            headers={
...
async def serve_frontend_ch():
    """Serve HTML frontend"""
    html_path = "index_hearthealth.html"
    if os.path.exists(html_path):
        return FileResponse(
            html_path,
            headers={
        ...
        return {
            "status": "running",
            "message": "Heart Health Chatbot API",
            "rag_status": "initialized" if rag_chain else "not_initialized"
        }
...
async def serve_frontend_ch():
    """Serve HTML frontend"""
    html_path = "index_bonehealth.html"
    if os.path.exists(html_path):
        return FileResponse(
            html_path,
            headers={
...
@app.get("/app_childhealth.js")
async def serve_app_js():
    """Serve JavaScript file"""
    js_path = "app_childhealth.js"
    if os.path.exists(js_path):
        return FileResponse(
            js_path,
            media_type="application/javascript",
    ...
    raise HTTPException(status_code=404, detail="app_childhealth.js not found")


@app.get("/app_pethealth.js")
async def serve_app_js():
    """Serve JavaScript file"""
    js_path = "app_pethealth.js"
    if os.path.exists(js_path):
        return FileResponse(
            js_path,
            media_type="application/javascript",
    ...
    raise HTTPException(status_code=404, detail="app_pethealth.js not found")

@app.get("/app_cancerhealth.js")
async def serve_app_js():
    """Serve JavaScript file"""
    js_path = "app_cancerhealth.js"
    if os.path.exists(js_path):
        return FileResponse(
            js_path,
            media_type="application/javascript",
    ...
    raise HTTPException(status_code=404, detail="app_cancerhealth.js not found")

@app.get("/app_bonehealth.js")
async def serve_app_js():
    """Serve JavaScript file"""
    js_path = "app_bonehealth.js"
    if os.path.exists(js_path):
        return FileResponse(
            js_path,
            media_type="application/javascript",
    ...
    raise HTTPException(status_code=404, detail="app_bonehealth.js not found")


@app.get("/app_neurohealth.js")
async def serve_app_js():
    """Serve JavaScript file"""
    js_path = "app_neurohealth.js"
    if os.path.exists(js_path):
        return FileResponse(
            js_path,
            media_type="application/javascript",
    ...
    raise HTTPException(status_code=404, detail="app_neurohealth.js not found")

@app.get("/app_hearthealth.js")
async def serve_app_js():
    """Serve JavaScript file"""
    js_path = "app_hearthealth.js"
    if os.path.exists(js_path):
        return FileResponse(
            js_path,
            media_type="application/javascript",
    ...
    raise HTTPException(status_code=404, detail="app_hearthealth.js not found")
...
@app.get("/style_childhealth.css")
async def serve_style_css():
    """Serve CSS file"""
    css_path = "style_childhealth.css"
    if os.path.exists(css_path):
        return FileResponse(
            css_path,
            media_type="text/css",
    ...
    raise HTTPException(status_code=404, detail="style_childhealth.css not found")

@app.get("/style_cancerhealth.css")
async def serve_style_css():
    """Serve CSS file"""
    css_path = "style_cancerhealth.css"
    if os.path.exists(css_path):
        return FileResponse(
            css_path,
            media_type="text/css",
    ...
    raise HTTPException(status_code=404, detail="style_cancerhealth.css not found")


@app.get("/style_neurohealth.css")
async def serve_style_css():
    """Serve CSS file"""
    css_path = "style_neurohealth.css"
    if os.path.exists(css_path):
        return FileResponse(
            css_path,
            media_type="text/css",
    ...
    raise HTTPException(status_code=404, detail="style_neurohealth.css not found")


@app.get("/style_hearthealth.css")
async def serve_style_css():
    """Serve CSS file"""
    css_path = "style_hearthealth.css"
    if os.path.exists(css_path):
        return FileResponse(
            css_path,
            media_type="text/css",
    ...
    raise HTTPException(status_code=404, detail="style_hearthealth.css not found")

@app.get("/style_bonehealth.css")
async def serve_style_css():
    """Serve CSS file"""
    css_path = "style_bonehealth.css"
    if os.path.exists(css_path):
        return FileResponse(
            css_path,
            media_type="text/css",
    ...
    raise HTTPException(status_code=404, detail="style_bonehealth.css not found")

@app.get("/style_pethealth.css")
async def serve_style_css():
    """Serve CSS file"""
    css_path = "style_pethealth.css"
    if os.path.exists(css_path):
        return FileResponse(
            css_path,
            media_type="text/css",
    ...
    raise HTTPException(status_code=404, detail="style_pethealth.css not found")


# For a specific image file
@app.get("/images/neuroapp.jpg")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/neuroapp.jpg"
    ...
    raise HTTPException(status_code=404, detail="neuroapp.jpg not found")

# For a specific image file
@app.get("/images/neuropic.jpg")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/neuropic.jpg"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="neuropic.jpg not found")

# For a specific image file
@app.get("/images/cancerpic.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/cancerpic.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="cancerpic.png not found")


# For a specific image file
@app.get("/images/pet.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/pet.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="pet.png not found")

# For a specific image file
@app.get("/images/petapp.jpg")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/petapp.jpg"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="petapp.jpg not found")


# For a specific image file
@app.get("/images/childhlpic.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/childhlpic.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="childhlpic.png not found")


# For a specific image file
@app.get("/images/onco.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/onco.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="onco.png not found")


# For a specific image file
@app.get("/images/paedtriatics.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/paedtriatics.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="paedtriatics.png not found")

# For a specific image file
@app.get("/images/cardiovascular.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/cardiovascular.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="cardiovascular.png not found")

# For a specific image file
@app.get("/images/orthopedic.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/orthopedic.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="orthopedic.png not found")

# For a specific image file
@app.get("/images/wmhealthpic.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/wmhealthpic.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="wmhealthpic.png not found")

# For a specific image file
@app.get("/images/hearthlapp.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/hearthlapp.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="hearthlapp.png not found")
...
# For a specific image file
@app.get("/images/orthoapp.jpg")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/orthoapp.jpg"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="orthoapp.jpg not found")

# For a specific image file
@app.get("/images/gynaeo.jpg")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/gynaeo.jpg"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="gynaeo.jpg not found")

# For a specific image file
@app.get("/images/gynaeo1.png")
async def serve_logo():
    """Serve logo image"""
    img_path = "images/gynaeo1.png"
    if os.path.exists(img_path):
        return FileResponse(
            img_path,
            media_type="image/png",
    ...
    raise HTTPException(status_code=404, detail="gynaeo1.png not found")
